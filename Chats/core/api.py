...
#For showing only online users by using session
...
class UserModelViewSet(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        queryset = User.objects.filter(id__in=uid_list)
        # Get all users except yourself
        #print("Hit Refresh for User")
        self.queryset = queryset.exclude(id=request.user.id)
